...
const EmailButton = () => {
  const handleEmailClick = () => {
    window.location.href = "mailto:OptiCropsaidevelopers@gmail.com";
  };
  ...
  return (
    ...
    >
      ...
      <span>OptiCropsidevelopers@gmail.com</span>
    </button>
  );
};
      ...
      <div className="w-full bg-light-green-200 flex flex-col items-center lg:w-1/2">
        <div className="bg-white p-5 rounded-lg shadow-md">
          ...
          <h1 className="text-2xl font-bold mb-4 text-center capitalize">
            Share your comment or idea on OptiCrops AI
          </h1>
